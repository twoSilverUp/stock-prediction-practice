...
if __name__ == "__main__":
	...
	codeListFilename = "/content/stock_market_reinforcement_learning/sample_data/000660.csv"
	modelFilename = None
	...
	env = MarketEnv(dir_path = "./sample_data", target_codes = list(codeMap.keys()), input_codes = [], start_date = "2013-08-26", end_date = "2015-08-25", sudden_death = -1.0)
